    ...
    <div className="ax-mac-desktop">
      <div className="ax-mac-window">
        ...
        <header className="ax-mac-titlebar">
          <a className="ax-prototype-brand" href="#/atlas" aria-label="效果图谱总览"><span className="ax-prototype-dot" aria-hidden="true" /><span>效果图谱</span><small>EFFECTS ATLAS</small></a>
