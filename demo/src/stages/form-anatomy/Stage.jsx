  ...
  return (
    <div className="fm" style={style}>
      <div className="fm-head">
        ...
        <span {...node('form.search', 'fm-search')}>⌕ 搜索模板</span>
      </div>
      ...
      <div className="fm-cols">
        <div className="fm-col">
          <label className="fm-field">
            ...
            <span {...node('form.text', 'fm-control')}>视元</span>
          </label>

          <label className="fm-field">
            <span className="fm-label">访问口令</span>
            <span {...node('form.password', 'fm-control')}>••••••••</span>
          </label>

          <div className="fm-pair">
            <label className="fm-field">
              <span className="fm-label">席位</span>
              <span {...node('form.number', 'fm-control fm-narrow')}>4 <i>⌃⌄</i></span>
            </label>
            <label className="fm-field">
              <span className="fm-label">启用日期</span>
              <span {...node('form.date', 'fm-control fm-narrow')}>2026-09-03</span>
            </label>
          </div>

          <div {...node('form.date.picker', 'fm-picker')}>
          ...
          <label className="fm-field">
            ...
            <span {...node('form.select', 'fm-control')}>标准版 ⌄</span>
          </label>

          <div className="fm-field">
            <span className="fm-label">区域</span>
            <div {...node('form.dropdown', 'fm-dropdown')}>
          ...
          <label className="fm-field">
            ...
            <span {...node('form.combobox', 'fm-control')}>陈<i className="fm-cb-caret">|</i><em className="fm-cb-hint">陈以宁</em></span>
          </label>
        </div>

        <div className="fm-col">
          <fieldset {...node('form.fieldset', 'fm-fieldset')}>
            <legend>通知方式</legend>

            <div {...node('form.checkbox.group', 'fm-group')}>
              <label {...node('form.checkbox', 'fm-check')}><i className="on" />邮件</label>
              <label className="fm-check"><i />站内信</label>
            </div>

            <div {...node('form.radio.group', 'fm-group')}>
              <label {...node('form.radio', 'fm-radio')}><i className="on" />实时</label>
          ...
          <div className="fm-field fm-inline">
            ...
            <span {...node('form.switch', 'fm-switch')}><i /></span>
          </div>

          <div className="fm-field">
            <span className="fm-label">并发上限</span>
            <span {...node('form.slider', 'fm-slider')}><i className="fm-track" /><i className="fm-thumb" /></span>
          </div>

          <div className="fm-field">
            <span className="fm-label">活跃时段</span>
            <span {...node('form.slider.multi', 'fm-slider')}>
          ...
          <div className="fm-field">
            ...
            <span {...node('form.textarea', 'fm-textarea')}>给团队的一句话说明。</span>
            <span {...node('form.charcount', 'fm-charcount')}>还可输入 88 字</span>
          </div>

          <div {...node('form.upload', 'fm-upload')}>
            <b>拖拽文件到此</b>
            <span>或点击选择 · 单个不超过 20 MB</span>
          </div>

          <p {...node('form.error', 'fm-error')}>工作区名称已被占用，换一个。</p>
        </div>
      </div>
    </div>
  )
