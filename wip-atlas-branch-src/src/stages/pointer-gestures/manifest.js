...
export default {
  ...
  /* 这台 39 条，最需要分区。变体按手势类型分两组，热区一组，
   * 24 个参数按「它们管什么」分四组，每组 6 个——都落在 3–7 的区间里。 */
  zones: [
    {
      id: 'pointer-motion',
      labelZh: '指针与位移手势',
      descriptionZh: '指针在动就触发的那几种，差别在于要不要按下、位移来自谁。',
      variantIds: [
        'atlas-interaction-design-phenomenon-usedrag',
        'atlas-interaction-design-phenomenon-usemove',
        'atlas-interaction-design-phenomenon-usehover',
        'atlas-interaction-design-phenomenon-usescroll',
        'atlas-interaction-design-phenomenon-usewheel',
      ],
    },
    {
      id: 'timed-multi',
      labelZh: '时序与多点手势',
      descriptionZh: '看的是时间与手指数量：按多久、几个指头、多种手势怎么共处。',
      variantIds: [
        'atlas-interaction-design-phenomenon-usepinch',
        'atlas-interaction-design-phenomenon-usepress',
        'atlas-interaction-design-phenomenon-uselongpress',
        'atlas-interaction-design-phenomenon-usegesture',
      ],
    },
    {
      id: 'scene-parts',
      labelZh: '场景部件',
      descriptionZh: '手势作用在谁身上：被拖的东西、接收它的地方、以及反馈。',
      hotspotIds: [
        'atlas-interaction-design-phenomenon-drag',
        'atlas-component-component-drop-zone',
        'atlas-interaction-design-phenomenon-press-tap-feedback',
        'atlas-interaction-design-phenomenon-focusring',
        'atlas-interaction-design-phenomenon-swipe-to-dismiss',
        'atlas-interaction-design-phenomenon-drag-to-reorder',
      ],
    },
    {
      id: 'start-detect',
      labelZh: '参数 · 起手判定',
      descriptionZh: '什么时候才算「开始了」：位移够不够、等多久、轻点算不算。',
      paramIds: [
        'atlas-interaction-design-phenomenon-threshold',
        'atlas-interaction-design-phenomenon-axisthreshold',
        'atlas-interaction-design-phenomenon-tapsthreshold',
        'atlas-interaction-design-phenomenon-delay',
        'atlas-interaction-design-phenomenon-filtertaps',
        'atlas-interaction-design-phenomenon-triggerallevents',
      ],
    },
    {
      id: 'direction-swipe',
      labelZh: '参数 · 方向与滑动',
      descriptionZh: '往哪个方向算数，以及多快多远才算一次滑动。',
      paramIds: [
        'atlas-interaction-design-phenomenon-axis',
        'atlas-interaction-design-phenomenon-preventscrollaxis',
        'atlas-interaction-design-phenomenon-anglebounds',
        'atlas-interaction-design-phenomenon-swipe-distance',
        'atlas-interaction-design-phenomenon-swipe-velocity',
        'atlas-interaction-design-phenomenon-swipe-duration',
      ],
    },
    {
      id: 'range-feel',
      labelZh: '参数 · 活动范围与手感',
      descriptionZh: '能走多远、到头了怎么办、从哪儿起步。',
      paramIds: [
        'atlas-interaction-design-phenomenon-bounds',
        'atlas-interaction-design-phenomenon-rubberband',
        'atlas-interaction-design-phenomenon-from',
        'atlas-interaction-design-phenomenon-scalebounds',
        'atlas-interaction-design-phenomenon-preventscroll',
        'atlas-interaction-design-phenomenon-preventdefault',
      ],
    },
    {
      id: 'pointer-source',
      labelZh: '参数 · 指针来源与捕获',
      descriptionZh: '认哪种指针、认哪个键，以及事件锁在谁身上。',
      paramIds: [
        'atlas-interaction-design-phenomenon-pointer-capture',
        'atlas-interaction-design-phenomenon-pointer-touch',
        'atlas-interaction-design-phenomenon-pointer-lock',
        'atlas-interaction-design-phenomenon-pointer-buttons',
        'atlas-interaction-design-phenomenon-modifierkey',
        'atlas-interaction-design-phenomenon-enabled',
      ],
    },
  ],
