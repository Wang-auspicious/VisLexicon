...
export default {
  ...
  /* 变体台没有空间分区，改按行为分区：有没有遮罩、抢不抢焦点、要不要回应。 */
  zones: [
    {
      id: 'non-modal-hints',
      labelZh: '非模态提示层',
      descriptionZh: '贴着锚点出现，不抢焦点，也不阻断底页。',
      variantIds: [
        'atlas-component-component-tooltip',
        'atlas-component-component-popover-hint-explainer',
        'atlas-component-component-popover-api-explainer',
      ],
      hotspotIds: ['atlas-component-component-tooltip-icon-button'],
    },
    {
      id: 'dialogs',
      labelZh: '对话框与检索浮层',
      descriptionZh: '居中浮起、要用户处理一件事的那一层，模态与非模态都在这里。',
      variantIds: [
        'atlas-component-component-dialog',
        'atlas-component-component-dialog-modal',
        'atlas-component-component-alert-and-message-dialogs',
        'atlas-component-component-feedback-dialog',
        'atlas-component-component-search-dialog',
    ...
    },
    {
      id: 'ambient',
      labelZh: '通知与常驻角落',
      descriptionZh: '不打断主任务，自己出现也自己退场。',
      variantIds: [
        'atlas-component-component-alert',
        'atlas-component-component-notification-banner',
        'atlas-component-component-toast',
        'atlas-component-component-assistant-modal',
      ],
    },
  ],

  /* 对照组。四条判据全部来自本清单的批注与语料定义，没有一格是凑的。 */
  compareSets: [
    {
      id: 'overlay-four',
      ...
      cells: {
        'atlas-component-component-tooltip': {
          focus: '不抢焦点；锚点被悬停或聚焦时才出现。',
          keyboard: '锚点用键盘聚焦时也必须出现，不能只认鼠标悬停。',
          dismissal: '锚点失去悬停或焦点即消失。',
          modality: '无遮罩、不抢焦点；里面放可交互内容就已经不是 tooltip 了。',
          persistence: '只在悬停或聚焦期间存在。',
        },
        'atlas-component-component-popover-api-explainer': {
          focus: null,
          keyboard: 'Esc 关闭。',
          dismissal: '点外面自动关（light dismiss），Esc 也关。',
          modality: '原生能力，不需要遮罩。',
          persistence: '同层互斥：同层再开一个，前一个就关掉。',
        },
        'atlas-component-component-dialog': {
          focus: null,
          keyboard: null,
          dismissal: null,
          modality: '非模态：没有遮罩，底页仍然可以滚动和点击——没有遮罩就不叫 modal。',
          persistence: null,
        },
        'atlas-component-component-dialog-modal': {
          focus: '焦点陷阱：焦点锁在这一层里。',
          keyboard: 'Tab 走不出这一层。',
          dismissal: '用户不回应就走不了。',
          modality: '遮罩 + 底页惰性：对话框以外的内容不可交互。',
          persistence: '一直在，直到用户给出回应。',
        },
      },
    },
  ],

  /* 整台演的就是浮层/遮罩这一区：十三种浮层 + 一个带提示的图标按钮。 */
  positionRegions: [
    {
      region: 'overlay',
      termIds: [
        ...
        'atlas-component-component-assistant-modal',
        'atlas-component-component-feedback-dialog',
        'atlas-component-component-tooltip-icon-button',
      ],
    },
  ],
