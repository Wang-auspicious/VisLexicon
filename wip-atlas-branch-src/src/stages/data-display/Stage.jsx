    ...
    <div className="dd" style={style}>
      ...
      <div className="dd-grid">
        <div className="dd-card dd-span2">
          ...
          <div {...node('data.table', 'dd-table')} data-zone="tabular">
            <div className="dd-tr dd-th"><span>运行</span><span>状态</span><span {...node('data.numcol', 'dd-num')} data-zone="tabular">耗时 ms ⌃</span></div>
            {ROWS.map((r) => (
        ...
        <div className="dd-card">
          ...
          <table {...node('data.table.static', 'dd-static')} data-zone="tabular">
            <tbody>
        ...
        <div className="dd-card">
          ...
          <div {...node('data.grid', 'dd-cells')} data-zone="tabular">
        ...
        <div className="dd-card">
          ...
          <div {...node('data.treegrid', 'dd-treegrid')} data-zone="tabular">
        ...
        <div className="dd-card">
          ...
          <ul {...node('data.list', 'dd-list')} data-zone="lists-trees">
            <li>东京</li><li>法兰克福</li>
          </ul>
          <ul {...node('data.listbox', 'dd-listbox')} data-zone="lists-trees">
        ...
        <div className="dd-card">
          ...
          <div {...node('data.tree', 'dd-tree')} data-zone="lists-trees">
            <div>▾ 组织</div><div className="dd-in">团队</div><div className="dd-in">成员</div>
          </div>
          <div {...node('data.filetree', 'dd-tree dd-filetree')} data-zone="lists-trees">
        ...
        <div className="dd-card">
          ...
          <div className="dd-chips">
            <span {...node('data.avatar', 'dd-avatar')} data-zone="markers">宁</span>
            <span {...node('data.badge', 'dd-badge')} data-zone="markers">12</span>
            <span {...node('data.badge.disclosure', 'dd-disclosure')} data-zone="markers">▾ 3 项</span>
            <span {...node('data.tag', 'dd-tag')} data-zone="markers">生产 ×</span>
          </div>
          <div {...node('data.timeline', 'dd-timeline')} data-zone="markers">
        ...
        <div className="dd-card">
          ...
          <div {...node('data.chart', 'dd-chart')} data-zone="graphics-code">
            {[38, 62, 44, 80, 55, 71].map((h, i) => <i key={i} style={{ height: `${h}%` }} />)}
          </div>
          <div {...node('data.activity', 'dd-activity')} data-zone="graphics-code">
        ...
        <div className="dd-card">
          ...
          <div {...node('data.heat', 'dd-heat')} data-zone="graphics-code">
            {Array.from({ length: 16 }, (_, i) => <i key={i} className={`lv${(i * 5) % 4}`} />)}
          </div>
          <div {...node('data.flow', 'dd-flow')} data-zone="graphics-code">
        ...
        <div className="dd-card dd-span2">
          ...
          <pre {...node('data.code', 'dd-code')} data-zone="graphics-code"><code>{'const stage = registry.get("data-display")\nstage.claims.filter((c) => c.slot === "hotspot")'}</code></pre>
        </div>
      </div>
    </div>
  )
